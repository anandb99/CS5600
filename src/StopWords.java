...
public class StopWords 
{
	...
	{
		System.out.println(removeStopWords("how to decalre int in java"));
	}
	*/

	public static Map removeStopWords(String query) 
	{
...
//		Scanner fip1 = new Scanner(new String("contains java"));
		//Scanner fip1 = new Scanner(new String("how to decalre an int in java"));
		Scanner fip1 = new Scanner(query);
